...
user:
	kubectl apply -f user/tekton/serviceAccount.yaml -f users/tekton/pipeline-resource.yaml -f user/tekton/build-push-tasks.yaml -f  user/tekton/deploy-task.yaml -f  user/tekton/build-push-taskrun.yaml -f  user/tekton deploy-taskrun.yaml -f user/tekton/pipeline.yaml -n test
