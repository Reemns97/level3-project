...
front-end: 
	kubectl apply -f front-end/serviceAccount.yaml -f front-end/pipeline-resource.yaml -f front-end/build-push-tasks.yaml -f  front-end/deploy-task.yaml -f  front-end/build-push-taskrun.yaml -f  front-end/deploy-taskrun.yaml -f front-end/pipeline.yaml -f front-end/ingress.yaml -n test
